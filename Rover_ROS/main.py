...
#Camera Control
    def Cam1(event):
        ...
        pub.publish(21)
        event.textEdit.setText("Cam1")
        #rate.sleep()
    def Cam2(event):
        #print("Bot/Arm")
        rospy.loginfo("Bot/Arm")
        pub.publish(22)
        event.textEdit.setText("Cam2")
        #rate.sleep()
...
# Rover Control
    def forward(event):
        ...
        pub.publish(1)
        event.textEdit.setText("Forward")
        #rate.sleep()
    ...
    def forward_left(event):
        ...
        pub.publish(2)
        event.textEdit.setText("Forward Left")
        #rate.sleep()
    ...
    def forward_right(event):
        ...
        pub.publish(3)
        event.textEdit.setText("Forward Right")
        #rate.sleep()
    ...
    def backward_right(event):
        ...
        pub.publish(6)
        event.textEdit.setText("Backward Right")
        #rate.sleep()
    ...
    def Arm1Front(self):
        if self.verticalSlider.value() <= 97:
            ...
            self.textEdit.setText("Can't go Up more")
    ...
    def Arm1Back(self):
        if self.verticalSlider.value() != 0:
            ...
            self.textEdit.setText("Can't go down more")
